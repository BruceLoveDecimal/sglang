...
<table style={{width: "100%", borderCollapse: "collapse", tableLayout: "fixed"}}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.05)"}}>See the <a href="/cookbook/autoregressive/Jina/Jina-OCR">Jina-OCR recipe</a>. No remote code required; the bundled FastMTP head is available through <code>--speculative-algorithm NEXTN</code>.</td>
    </tr>
    <tr>
